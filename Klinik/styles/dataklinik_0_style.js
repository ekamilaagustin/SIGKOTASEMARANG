...
var style_dataklinik_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Klinik");
    var labelText = "";
    size = 0;
    ...
    if (value > 3.000000 && value <= 37.333333) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 37.333333 && value <= 71.666667) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 71.666667 && value <= 106.000000) {
            style = [ new ol.style.Style({
