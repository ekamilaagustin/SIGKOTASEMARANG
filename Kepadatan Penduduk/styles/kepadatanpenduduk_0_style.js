...
var style_kepadatanpenduduk_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value > 1033.000000 && value <= 4534.666667) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 4534.666667 && value <= 8036.333333) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 8036.333333 && value <= 11538.000000) {
            style = [ new ol.style.Style({
